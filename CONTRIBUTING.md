...
Each reference should change how an agent handles that topic without duplicating `SKILL.md`'s shared rules. After changing `SKILL.md`, run `./scripts/build-portable.ps1` and validate the skill.
